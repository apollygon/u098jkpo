...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        useBech32->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Bech32 addresses (BIP-173) are cheaper to spend from and offer better protection against typos. When unchecked a P2SH wrapped SegWit address will be created, compatible with older wallets.", 0));
#endif // QT_NO_TOOLTIP
        useBech32->setText(QApplication::translate("ReceiveCoinsDialog", "Generate Bech32 address", 0));
