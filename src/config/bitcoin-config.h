...
#define PACKAGE_BUGREPORT "https://github.com/Soferox/soferox/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Soferox Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Soferox Core 2.16.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "soferox"

/* Define to the home page for this package. */
#define PACKAGE_URL "www.soferox.org"
