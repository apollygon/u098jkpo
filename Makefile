...
ACLOCAL = ${SHELL} /root/sfx/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /root/sfx/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/sfx/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/sfx/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
...
MAINT = 
MAKEINFO = ${SHELL} /root/sfx/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/sfx
abs_srcdir = /root/sfx
abs_top_builddir = /root/sfx
abs_top_srcdir = /root/sfx
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/sfx/build-aux/install-sh
