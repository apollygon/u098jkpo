...
!define COMPANY "Soferox Core project"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "Soferox Core"
...
!else
InstallDir $PROGRAMFILES\Soferox
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Soferox Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\soferox-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Soferox Core (testnet, -bit).lnk" "$INSTDIR\soferox-qt" "-testnet" "$INSTDIR\soferox-qt" 1
    ...
    WriteRegStr HKCR "soferox" "URL Protocol" ""
    WriteRegStr HKCR "soferox" "" "URL:Soferox"
    WriteRegStr HKCR "soferox\DefaultIcon" "" $INSTDIR\soferox-qt
    WriteRegStr HKCR "soferox\shell\open\command" "" '"$INSTDIR\soferox-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\soferox-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Soferox Core (testnet, -bit).lnk"
